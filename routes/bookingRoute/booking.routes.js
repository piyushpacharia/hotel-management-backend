...
import { addBooking, getBookingsByAdminId, updateBooking, deleteBooking, updateCheckOut, updateBookingStatus } from "../../controllers/booking/booking.js";
...
router.put('/update-status/:bookingId', authMiddleware, updateBookingStatus);
